...
def request_routed(city_employee, phone_number, request_text):
	...
	email_body = "<p>Your public records request has been sent to %s, who is responsible for sending you the information you need.</p><p>If you have any questions or concerns, feel free to send a message to %s by clicking here or calling %s. You can read the full text of your records request below:</p><p></br>%s</br></p>"
	return subject_line, email_body
