...
def is_spam(comment):
	...
	if akismet.comment_check(key = key, blog = blog, user_ip = '127.0.0.1', user_agent = 'Mozilla/5.0 (...) Gecko/20051111 Firefox/1.5', comment_content = comment) or 'http' in comment:
		return True
	return False
