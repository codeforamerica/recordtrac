...
def check_for_spam():
    # Spam filter is currently implemented to prevent bot spamming, so if
    # someone is logged in they have already verified they are human
    if current_user.is_authenticated():
        return False
    # This only needs to work in production, unless a local config variable is
    # set to indicate otherwise
