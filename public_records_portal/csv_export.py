...
def export():
    ...
    db_headers = ['id', 'text', 'date_received',
                  'date_created', 'due_date', 'extended']
    all_headers = ['Request ID', 'Request Text', 'Date Received', 'Date Created', 'Date Due', 'Extended?',
                   'Requester Name', 'Requester Phone', 'Department Name', 'Point of Contact', 'All staff involved', 'Status']
