...
app.jinja_env.filters[
    'get_scribd_download_url'] = scribd_helpers.get_scribd_download_url
...
app.jinja_env.filters[
    'get_responses_chronologically'] = prr.get_responses_chronologically
app.jinja_env.filters[
    'get_request_data_chronologically'] = prr.get_request_data_chronologically
...
app.jinja_env.filters[
    'display_staff_participant'] = helpers.display_staff_participant
