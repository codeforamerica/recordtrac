...
class ResponsePresenter:
    ...
    def display_text(self):
        if self.type == "offline":
            ...
            if not download_url:
                download_url = scribd_helpers.get_scribd_download_url(
                    doc_id=self.response.doc_id, record_id=self.response.id)
                if not download_url:
            ...
            # return "<a href='%s' rel='tooltip' data-toggle='tooltip'
            # data-placement='top' data-original-title='%s'>%s </a>" %
