...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            ...
            finishButtonText : "<i class='icon-thumbs-up'></i> Thanks, I'm good for now",
        ...
        function add_nav_btn(content, i)
        {
            ...
            {
                nextButton = '<button class="btn btn-mini bootstro-next-btn">' + $el.attr('data-bootstro-nextButtonText') +  '</button>';
            }
            else 
            {
            ...
            {
                finishButton = '<button class="btn btn-mini bootstro-finish-btn">' + $el.attr('data-bootstro-finishButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.finishButton != 'undefined' /*&& settings.finishButton != ''*/)
                    ...
                    finishButton = '<button class="btn btn-mini bootstro-finish-btn">' + settings.finishButtonText + '</button>';
            }
