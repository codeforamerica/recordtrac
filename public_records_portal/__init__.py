...
envvars = [
    ...
    # The path/URL at which a csv containing staff data lives. If this is not
    # set, no one will be able to log into RecordTrac
    'STAFF_URL',
    # The path/URL at which a csv containing liaisons/department data lives.
    # If this is not set, initial request routing will always be directed to
    # the default owner
    'LIAISONS_URL',
    ...
    # hosted. (.png or .jpg)
    'LOGO_ON_BLACK_URL',
    # Set if you are running tests. Primarily used to ignore @login_requireds
    # when running tests.
    'TESTING',
